export const projects = {
    ...
    aa: {
        info: {
            ...
            overview: "Ask a designer to design his own home and construct it too. Alike to a self-performing design-build contractor contracting himself for a personal project, aA started as an assessment of personal branding and turned into an introspective 'focus all of a multi-disciplined professional's skills and interests into one elevator pitch' web application. Interestingly enough, a web application can make the pitch and it can also step out of the elevator and continue the conversation deeper into the details if appropriate- all without the use of a single elevator.",
            ...
            approach: {
                ...
                synthesis: "Subconsciously, a person will begin to forget the medium as the interaction between it and them progresses positively, also causing the experience to rise exponentially in value. The intention becomes a platform that can interact with the user and inform deeper without loosing a sense of place.",
                design: "An opening ceremony, inviting and responsive 'onMouseMove' animation for two overlapped and translateZ-d SVGs, and a menu that sorts topics and data into levels of detail, all while preserving 'white space' (or 'black mirror-esque space') that features item prominence and allows background media shows to transform the experience in to one that is project-specific.",
                delivery: "aA is deployed and hosted through github and github-pages; an AWS S3 Bucket used for media referencing."
            },
            prototype: null,
            nextSteps: "1) Gyroscopic AOM logo functionality for mobile devices. 2) Updates to wayfinding and tap responses for mobile devices. 3) Add project sections for different mediums and trades.",
            feSpotlights: {
                one: {
    ...
    avtc: {
        info: {
            ...
            approach: {
                research: "Websites of renowned shops in the likes of New York City's Bang Bang Forever were accounted for with the objective of growing the platform's viewer and overall clientbase.",
            ...
            prototype: null,
            nextSteps: "1) Updates to wayfinding and tap interactions for mobile devices. 2) Add project sections for different mediums and trades. 3) Create an opening animation for the website.",
            feSpotlights: {
                one: {
                    text: null,
                    media: null
    ...
    wip: {
        info: {
            ...
            overview: "WIP galleries experiment with the capacities of extrapolating the elements of a mainstream website in order for the curated works to take the prominence of the screen. The power behind the application continues as artists make WIP their own platform for showcasing their effors and guiding viewers through their personal collections. Users are invited to create thrir own profiles and manage several artistic personas and their respective bodies of work.",
            ...
            solution: "The content is to be alive and transform as one in a phisical gallery experience. Elements shift (without abandoning the spectator's perception) as the attention is called to the depths of a piece's detail and furthermore into all of a the artist's curated conceptions.",
            approach: {
                research: "Physical galleries- then virtual ones. The behavior of a gallery in a physical experience varies as wayfinding is not something you always have in sight, objects orbit, they hide behind each other, and the odd case implies that the spectator is alone. There's always movement and life inside the space.",
            ...
            prototype: null,
            nextSteps: "1) Expand support for mobile device viewing. 2) Search capabilities. 3) Improve overall wayfiding experience",
            feSpotlights: {
                one: {
                    text: null,
                    media: null
    ...
    fire: {
        info: {
            ...
            approach: {
                ...
                design: "The content should never be unvisible now. The user dives straight into the beautiful visual aspects of this plant while submerged into data about the substance as any other article bought at a pharmacy or place of recreation. The delivery should also allow the user to search for any particular strain and its data without blockers. Intrigues about the topic need feel welcomed; tended to promptly and transparently.",
    ...
    br: {
        info: {
            ...
            problem: "With the intention of exercise, a frontend web applciation is to be created with the utilization and manipulation of (a) built and public API('s).",
            solution: "The content shall shine through an elegantly produced interface. The character and importance of cannabis needs not to be sterilized, but to be celebrated in a way that is respectful to both the informer and the informed.",
            approach: {
                research: "Research was purely personal perference- when finding built and publicly accessible API's to then sort though what seemed to have potential to push the expected exercise's emotive boundaries.",
                synthesis: "Tim Biles' 'A Breaking Bad API' appeared within the list and that was it- (facts).",
                design: "As John Waters' book on shock value explains: 'To me, beauty is looks you can never forget. A face should jolt, not soothe'. Heisenberg is the face of the show as he is of anyone in hardship deciding upon unthinkable means to an end. Thanks, Bryan. The Bromine inspired branding directly shape-shifted from the show's opener says most of what will happen here. The user is splashed with fan-based sympathisation to then humanize the rest of the welcoming page; informing nonetheless of clear pathways accompanying the main logo at the top.",
                delivery: "Br is deployed and hosted through github and github-pages; media is referred from decentralized sources."
            },
            prototype: null,
            nextSteps: "1) Expand home page for more comprehensive collections with titles and other important quick-view aspects. 2) Optimizations to desktop and widescreen views. 3) Overall upgrade of presentation and .",
            feSpotlights: {
                one: {
                    text: null,
                    media: null
